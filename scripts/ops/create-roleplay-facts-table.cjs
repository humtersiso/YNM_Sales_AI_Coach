/**
 * 建立 roleplay_session_facts（Two-Gate 單一事實表）
 * 用法：node scripts/ops/create-roleplay-facts-table.cjs
 */
...
async function main() {
  const sqlPath = path.join(__dirname, "..", "..", "sql", "roleplay_session_facts.sql");
